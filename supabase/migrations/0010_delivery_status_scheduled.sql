-- M9-6: Fix delivery_status default from 'pending' to 'scheduled'
-- and update the RPC to use 'scheduled' as the default value

ALTER TABLE public.bookings
  ALTER COLUMN delivery_status SET DEFAULT 'scheduled';

-- Update existing 'pending' delivery statuses to 'scheduled'
UPDATE public.bookings SET delivery_status = 'scheduled' WHERE delivery_status = 'pending';

-- Recreate RPC with delivery_status default = 'scheduled'
